...
<div style="max-width: 600px; margin: 0 auto;">
    ...
    <div style="margin-bottom: 20px; display:flex; justify-content:space-between; align-items:center;">
        <div>
            <h3 style="margin:0;">Edit Satuan</h3>
            <p class="small-muted" style="margin:5px 0 0;">ID Satuan: #{{ $item->idsatuan }}</p>
        </div>
    ...
    <div class="card" style="background:white; padding:25px; border-radius:8px; border:1px solid #eee; box-shadow:0 2px 5px rgba(0,0,0,0.05);">
        <form method="POST" action="{{ route('satuan.update', $item->idsatuan) }}">
            @csrf
            @method('PUT')
            ...
            <div style="margin-bottom:15px;">
                ...
                <input name="nama_satuan" required value="{{ $item->nama_satuan }}" 
