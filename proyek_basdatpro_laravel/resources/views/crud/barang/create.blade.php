...
<div style="max-width: 800px; margin: 0 auto;">
    ...
    <div style="margin-bottom: 20px; display:flex; justify-content:space-between; align-items:center;">
        <div>
            <h3 style="margin:0;">Tambah Barang Baru</h3>
            <p class="small-muted" style="margin:5px 0 0;">Masukkan data barang inventaris baru.</p>
        </div>
        ...
        <form method="POST" action="{{ route('barang.store') }}">
            ...
            <div style="display:flex; gap:20px; margin-bottom:15px;">
                <div style="flex:1;">
                    ...
                    <input name="nama" required value="{{ old('nama') }}" placeholder="Contoh: Semen Tiga Roda" 
                ...
                <div style="width:150px;">
                    ...
                    <input name="jenis" required value="{{ old('jenis') }}" placeholder="A/B/C" maxlength="1" 
